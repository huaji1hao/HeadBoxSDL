...
public:
	// Constructors
	Scyjz14ImageObject(BaseEngine* pEngine, std::string strURL, bool useTopLeftFor00 = true, bool bVisible = true)
		: DisplayableObject(0, 0, pEngine, 100, 100, useTopLeftFor00),
